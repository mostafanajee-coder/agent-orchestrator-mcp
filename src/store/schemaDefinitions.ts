 ...
 * reviewed Phase 4 post-migration states; version 7 is the Phase 7 evidence
 * and artifact integrity state; version 8 is the inert Phase 10B.2
 * integration-generation foundation.
 */
